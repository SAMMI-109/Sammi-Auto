...
folder_path = '/sdcard/AUTO_CREATE_JUTT.txt'
try:
...
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mFACEBOOK \033[1;91m  :   \033[1;92m𝐓𝐄𝐀𝐌-𝐂𝐘𝐁𝐄𝐑-𝟎𝟑
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mTOOL TYPE \033[1;91m :   \033[1;92mAUTO-CREATE
...
def auto_create_fb_method_1_() -> None:
    ...
    for make in range(50000):
        ...
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}CYBER-XD\033[1;37m]<×>[{make+1}|\033[1;32m{oks}\033[1;37m]> ');sys.stdout.flush()
        ...
        if "c_user" in py_submit.cookies:
            ...
            print('\r\033[1;32m<[CYBER-OK]> ' + uid + ' | ' + pasw2 + '\033[1;37m')
            ...
            print(f"\r \033[1;97m[\033[1;31m–\033[1;97m] COOKIE : {coki}")
            #linex()
            file_path_ok = os.path.join(folder_path, 'CREATE-OK.txt')
            file_path_cookies = os.path.join(folder_path, 'CREATE-COOKIE.txt')
...
def auto_create_fb_method_2_() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}Create\033[1;37m]<×>[{make+1}|\033[1;32m{len(ok)}\033[1;37m]> ');sys.stdout.flush()
        ses = requests.Session()
        fake = Faker()
